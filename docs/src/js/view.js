	...
	<i class="fas fa-bars text-white p-2"></i></span>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav bg-white p-2">
				...
				<button type="button" class="nav-item nav-link btnMenu"> <a href="index.html" class="closeSesion"><i class="fas fa-home"></i> Home</a></button>
...
window.view.question = () => {
	...
	Problemas y cuidados
                    ...
                    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                        <div class="card-body">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eros leo, venenatis a eleifend eget, faucibus at urna. Proin non pellentesque est. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut vel elit
                            quis orci aliquet posuere vel eu nunc. Praesent lacus arcu, tempor ac diam at, egestas placerat enim. Duis a justo vel arcu venenatis posuere eu vel tortor. Quisque facilisis mauris neque, et congue quam condimentum in. Donec
                            eleifend dapibus mattis. Vestibulum ligula velit, luctus dapibus orci ac, congue viverra diam. Nam at leo massa. Cras lectus mi, vulputate nec viverra non, finibus nec mauris. Maecenas in hendrerit sem.
                        </div>
                    </div>
                </div>
                <div class="card">
...
window.view.calcular = () => {
	...
	<option value="780">Tarifa Alta: $780</option>
	<option value="700">Tarifa Media: $700</option>
	<option value="650">Tarifa Baja: $650</option>
	</select>
                </div>
            </form>
